...
│   │   │   ├── flight/      # Tìm kiếm chuyến bay (Duffel API)
...
- API token: [Duffel](https://duffel.com/) (sandbox miễn phí, prefix `duffel_test_...`)
...
DUFFEL_TOKEN=duffel_test_your_token_here
```
...
- [x] Migration: Amadeus → Duffel Air API
- [x] Unit tests (4 files, 40 tests passing)
