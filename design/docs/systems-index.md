...
|---|-----|-------|----------|-----------|-----|
| 1 | Backend API Gateway | Foundation | MVP | Chưa bắt đầu | — |
| 2 | IATA Code Mapper | Foundation | MVP | Chưa bắt đầu | — |
| 3 | Error Handler | Foundation | MVP | Chưa bắt đầu | — |
| 4 | NLP Parser | Core | MVP | Chưa bắt đầu | — |
| 5 | Input Validator | Core | MVP | Chưa bắt đầu | — |
| 6 | Flight Search | Core | MVP | Chưa bắt đầu | — |
| 7 | Filter Engine | Feature | MVP | Chưa bắt đầu | — |
| 8 | Conversation State Manager | Feature | MVP | Chưa bắt đầu | — |
| 9 | Redirect Handler | Feature | MVP | Chưa bắt đầu | — |
| 10 | Result Display | Presentation | MVP | Chưa bắt đầu | — |
| 11 | Chat UI | Presentation | MVP | Chưa bắt đầu | — |
